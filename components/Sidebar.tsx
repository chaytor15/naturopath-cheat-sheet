...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`fixed left-0 top-[60px] bottom-0 z-30 bg-white/80 backdrop-blur-lg border-r border-white/60 shadow-sm transition-all duration-300 ${
        ...
        <nav className="flex-1 p-4 space-y-1">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <span className={`flex-shrink-0 ${active ? "text-white" : "text-[#4B543B]"}`}>
                  {item.icon}
                </span>
                {!isCollapsed && (
